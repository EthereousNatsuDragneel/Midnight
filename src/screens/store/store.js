...
const {buyDoubleDip,buyGoWithTheCrowd,buyFifty}=useStore(props)
...
<TouchableOpacity onPress={buyGoWithTheCrowd}><Text style={{color:"yellow",fontSize:15,textAlign:"center"}}>Go With the Crowd, Rs. 15</Text></TouchableOpacity>
...
<TouchableOpacity onPress={buyDoubleDip}><Text style={{color:"yellow",fontSize:15,textAlign:"center"}}>Double Dip, Rs. 15</Text></TouchableOpacity>
...
<TouchableOpacity onPress={buyFifty}><Text style={{color:"yellow",fontSize:15,textAlign:"center"}}>50 50, Rs. 15</Text></TouchableOpacity>
