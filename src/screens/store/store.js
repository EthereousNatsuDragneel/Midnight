...
<TouchableOpacity onPress={buyDoubleDip}>
<Text style={{color:"yellow",fontSize:15,textAlign:"center"}}>Double Dip</Text></TouchableOpacity>
...
<TouchableOpacity onPress={buyFifty}>
<Text style={{color:"yellow",fontSize:15,textAlign:"center"}}>50 50</Text></TouchableOpacity>
