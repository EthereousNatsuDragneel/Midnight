...
<Text style={{color:"yellow",fontSize:"center",TextAlign:"center"}}>STORE</Text>
<Text style={{color:"center"}}>You can buy lifelines that can help you during the game. You can only use a lifeline once in one game. For example, you can buy two Double Dips, but you cannot use them both in the same game. But you can use one Double Dip and one 50 50 in the same game</Text>
<TouchableOpacity><Text style={{color:"center",fontSize:15,textAlign:"center"}}>Go With the Crowd, Rs. 15</Text></TouchableOpacity>
