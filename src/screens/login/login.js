...
<TouchableOpacity onPress={toggle}><Text style={{color:"yellow"}}>Show/hide password</Text></TouchableOpacity>
<TouchableOpacity onPress={loginHandle}><Text style={{color:"yellow"}}>Login</Text></TouchableOpacity>
<TouchableOpacity onPress={goToForgot}><Text style={{color:"yellow"}}>Forgot password?</Text></TouchableOpacity>
<TouchableOpacity onPress={goToSignup}><Text style={{color:"yellow"}}>Sign up</Text></TouchableOpacity>
